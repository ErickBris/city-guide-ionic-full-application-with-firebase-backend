City Guide Ionic 1.0 README
==========================

Thank you for downloading City Guide Ionic distribution.

This distribution includes a full working Cordova/Ionic project
...
directories:
    ...
    * [project]
      Includes a Grunt based ionic/cordova project. This is the project
      that is suggested to be used for development.
    * [release]
      Includes a generated Ionic project. This is a simplified version of
      the Grunt based project where all the grunt related automations and
...
------------------------
Quick start guide
https://docs.google.com/document/d/1QE1DzP7lmLVXYmCcWYS3MZxMfzXePmwKfWgAvF-OtQ4/edit?usp=sharing
