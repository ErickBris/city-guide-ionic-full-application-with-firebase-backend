	...
	grunt.initConfig({
			...
			development: {
				constants: {
					ENV: {
						...
						// dataProvider: 'REMOTE',
						// apiUrl: 'https://skounis-dev.s3.amazonaws.com/mobile-apps/city-guide/',
						// dataProvider: 'LOCAL',
						// apiUrl: 'misc/',
						dataProvider: 'FIREBASE',
						firebaseConfig: {
							apiKey: "AIzaSyBgFUovfxn-XSHoQVXQ1gubWvbGGmyTchg",
							authDomain: "city-guide-ionic-a5a3f.firebaseapp.com",
							databaseURL: "https://city-guide-ionic-a5a3f.firebaseio.com"
						},
		...
		wiredep: {
			app: {
				...
				ignorePath: /\.\.\//,
				exclude: [ 'app/bower_components/ionic/release/css/ionic.css'],
				overrides: {
					"ionic-toast": {
						"main": "./dist/ionic-toast.bundle.min.js"
					}
				}
			}
		},
